...
namespace P2P.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260829192516_AddGoodsReceipt")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P2P.Domain.Configuration.FieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("configuration_field_definition", (string)null);
                });
            ...
            modelBuilder.Entity("P2P.Domain.Receiving.GoodsReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("receiving_goods_receipt", (string)null);
                });

            modelBuilder.Entity("P2P.Domain.Receiving.GoodsReceiptLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("receiving_goods_receipt_line", (string)null);
                });
            ...
            modelBuilder.Entity("P2P.Domain.Receiving.GoodsReceiptLine", b =>
                {
                    b.HasOne("P2P.Domain.Receiving.GoodsReceipt", null)
                        .WithMany("Lines")
